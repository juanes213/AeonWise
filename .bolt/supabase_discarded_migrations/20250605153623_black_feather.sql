/*
  ...
  1. Sample Profiles
    - Creates user profiles first to satisfy foreign key constraints
  2. Sample Courses
    - Adds educational content across different categories
  3. Sample Mentorship Profiles
    - Links mentors to existing profiles
*/

-- First, insert the sample profiles
