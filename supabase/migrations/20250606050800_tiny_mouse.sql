...
BEGIN
  ...
  VALUES
    ('00000000-0000-0000-0000-000000000001'::uuid, 'alexandria@example.com', crypt('password123', gen_salt('bf')), NOW(), NOW(), NOW(), '{"username":"Alexandria"}'::jsonb),
    ('00000000-0000-0000-0000-000000000002'::uuid, 'marcus@example.com', crypt('password123', gen_salt('bf')), NOW(), NOW(), NOW(), '{"username":"Marcus"}'::jsonb),
    ('00000000-0000-0000-0000-000000000003'::uuid, 'sophia@example.com', crypt('password123', gen_salt('bf')), NOW(), NOW(), NOW(), '{"username":"Sophia"}'::jsonb),
    ('00000000-0000-0000-0000-000000000004'::uuid, 'julian@example.com', crypt('password123', gen_salt('bf')), NOW(), NOW(), NOW(), '{"username":"Julian"}'::jsonb),
    ('00000000-0000-0000-0000-000000000005'::uuid, 'elena@example.com', crypt('password123', gen_salt('bf')), NOW(), NOW(), NOW(), '{"username":"Elena"}'::jsonb)
...
VALUES
  ('00000000-0000-0000-0000-000000000001'::uuid, 'Alexandria', 'alexandria@example.com', 850,
  ...
  ('00000000-0000-0000-0000-000000000002'::uuid, 'Marcus', 'marcus@example.com', 650,
  ...
  ('00000000-0000-0000-0000-000000000003'::uuid, 'Sophia', 'sophia@example.com', 720,
  ...
  ('00000000-0000-0000-0000-000000000004'::uuid, 'Julian', 'julian@example.com', 450,
  ...
  ('00000000-0000-0000-0000-000000000005'::uuid, 'Elena', 'elena@example.com', 320,
...
VALUES
  ('00000000-0000-0000-0000-000000000001'::uuid, '00000000-0000-0000-0000-000000000002'::uuid, 'connected', NOW() - INTERVAL '30 days'),
  ('00000000-0000-0000-0000-000000000002'::uuid, '00000000-0000-0000-0000-000000000003'::uuid, 'pending', NOW() - INTERVAL '15 days'),
  ('00000000-0000-0000-0000-000000000003'::uuid, '00000000-0000-0000-0000-000000000005'::uuid, 'connected', NOW() - INTERVAL '10 days'),
  ('00000000-0000-0000-0000-000000000004'::uuid, '00000000-0000-0000-0000-000000000005'::uuid, 'connected', NOW() - INTERVAL '20 days'),
  ('00000000-0000-0000-0000-000000000001'::uuid, '00000000-0000-0000-0000-000000000003'::uuid, 'pending', NOW() - INTERVAL '5 days');
...
BEGIN
  ...
  VALUES
    ('00000000-0000-0000-0000-000000000002'::uuid, python_course_id, 35, NOW() - INTERVAL '40 days'),
    ('00000000-0000-0000-0000-000000000001'::uuid, design_course_id, 20, NOW() - INTERVAL '30 days'),
    ('00000000-0000-0000-0000-000000000003'::uuid, web_dev_course_id, 75, NOW() - INTERVAL '50 days'),
    ('00000000-0000-0000-0000-000000000004'::uuid, data_science_course_id, 15, NOW() - INTERVAL '20 days'),
    ('00000000-0000-0000-0000-000000000005'::uuid, python_course_id, 50, NOW() - INTERVAL '25 days');
END $$;