/*
  ...
  2. Add profile records that reference auth users
  3. Add sample courses
  4. Add mentorship profiles linked to existing profiles

  Note: Using a DO block to handle auth user creation
*/
