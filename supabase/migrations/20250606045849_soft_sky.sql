/*
  ...
  1. New Data
    ...
    - Add sample matches between users
...
VALUES
  ('00000000-0000-0000-0000-000000000001', 'alexandria@example.com', NOW(), NOW(), NOW(), '{"username":"Alexandria"}'::jsonb),
  ('00000000-0000-0000-0000-000000000002', 'marcus@example.com', NOW(), NOW(), NOW(), '{"username":"Marcus"}'::jsonb),
  ('00000000-0000-0000-0000-000000000003', 'sophia@example.com', NOW(), NOW(), NOW(), '{"username":"Sophia"}'::jsonb),
  ('00000000-0000-0000-0000-000000000004', 'julian@example.com', NOW(), NOW(), NOW(), '{"username":"Julian"}'::jsonb),
  ('00000000-0000-0000-0000-000000000005', 'elena@example.com', NOW(), NOW(), NOW(), '{"username":"Elena"}'::jsonb);
